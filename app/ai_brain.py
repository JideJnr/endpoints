...
def oversee_prediction(prediction: dict[str, Any], detail: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    ai = _ollama_review(prompt_payload)
    if ai:
        return ai
        ...
        "messages": [
            {
                ...
                "content": (
                    ...
                    "Use the supplied rule-engine signals only. Do not invent team news. "
                    "Return compact JSON with keys: status, verdict, confidence_adjustment, risks, reasons."
                ),
            },
